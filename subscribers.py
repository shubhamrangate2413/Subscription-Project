...
new_data = pd.read_csv("new_appdata10.csv")

response = new_data['enrolled']
new_data.drop('enrolled', axis=1, inplace=True)

from sklearn.model_selection import train_test_split
X_train, X_test, y_train, y_test = train_test_split(new_data, response, test_size=0.2, random_state=0)
